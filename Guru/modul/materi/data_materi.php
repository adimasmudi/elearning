                  ...
                  <tbody>
                    ...
                    foreach ($sqlrole as $row) { ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="?page=materi&act=edit&ID=<?= $row['id_materi'] ?>" class="btn btn-dark btn-xs"><i class="fa fa-edit"></i> Edit</a>
                          <a href="?page=materi&act=del&ID=<?= $row['id_materi'] ?>" onclick="return confirm('Yakin Hapus Data ?')" class="btn btn-dark text-danger btn-xs"><i class="fa fa-trash"></i> Hapus</a>
                        </td>
