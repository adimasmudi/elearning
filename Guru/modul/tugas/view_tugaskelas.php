...
WHERE kelas_tugas.id_tugas='$_GET[tugas]' AND kelas_tugas.id_kelas='$_GET[kelas]'
");
...
<strong>Info!</strong> Ada <b>10</b> Siswa yang belum mengerjakan Tugas pada kelas ini .
</div> -->
					...
					<table class="table" id="data">
						...
						<tbody>
							...
							$siswa = mysqli_query($con, "SELECT * FROM tugas_siswa
								...
								AND tb_siswa.id_kelas='$_GET[kelas]'
								");
							foreach ($siswa as $s) { ?>
							<tr>
								<td><b><?= $nomor++; ?> .</b></td>
