            ...
            <table class="table table-striped table-hover table-condensed" id="data">
              ...
              <tbody>
                ...
                $sqlrole = mysqli_query($con, "SELECT * FROM ujian
                    ...
                    WHERE ujian.id_guru='$sesi' ORDER BY ujian.id_ujian DESC");
                ...
                foreach ($sqlrole as $row) { ?>
                  ...
                  <tr>
                    ...
                    <td><?= $row['mapel']; ?> </td>
                    <td>
                      <a href="?page=ujian&act=soal&id=<?= $row['id_ujian']; ?>"><b class="text-primary"> <em>OBJEKTIF</em></b></a>
                    </td>
                    <td><?= $row['acak']; ?></td>
                    ...
                    <td>
                      ...
                      <a href="?page=ujian&act=ujiandel&id=<?= $row['id_ujian']; ?>" onclick="return confirm('Yakin Hapus Data ?')" class="btn btn-dark btn-sm text-danger"><i class="fa fa-trash"></i> Hapus </a>
                    </td>
