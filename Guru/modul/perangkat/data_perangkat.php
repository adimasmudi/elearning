        ...
        <div class="card">
          <div class="card-body">
                            ...
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title">
                                  ...
                                  <img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <b> <?= $row['jenis_perangkat']; ?></b> | <?= $row['mapel']; ?> KELAS <?= $row['kelas']; ?>
                                </h4>
                                <hr>
                              </div>
            ...
            <td>
              ...
              <a href="?page=perangkat&act=del&ID=<?= $row['id_perangkat'] ?>" onclick="return confirm('Yakin Hapus Data ?')" class="btn btn-dark text-danger"><i class="fa fa-trash"></i> Hapus</a>
            </td>
