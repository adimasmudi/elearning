...
$kelas = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM tb_siswa
 INNER JOIN tb_master_kelas ON tb_siswa.id_kelas=tb_master_kelas.id_kelas
 WHERE tb_siswa.id_kelas='$_SESSION[kelas]' "));

$ujian = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM ujian
...
<div class="row">
  <div class="col-md-8">
    <div class="list-group-item top-heading">
      <h3 class="list-group-item-heading page-label">Informasi Ujian</h3>
    </div>
  ...
  <div class="col-md-4">
    ...
    $qnilai = mysqli_query($con, "SELECT * FROM nilai WHERE id_ujian='$_GET[ujian]' AND id_siswa='$_SESSION[id_siswa]'");
