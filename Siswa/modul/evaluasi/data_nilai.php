  									...
  									<tr>
  										...
  										<td>
  											<?php
												...
												$mapel = mysqli_query($con, "SELECT * FROM ujian INNER JOIN tb_master_mapel ON ujian.id_mapel=tb_master_mapel.id_mapel WHERE id_ujian='$r[id_ujian]'  ");
												foreach ($mapel as $m)
												?>
  											<?= $m['mapel'] ?>
  										</td>
  										<td>
  											<?php
												...
												$jenis = mysqli_query($con, "SELECT * FROM ujian INNER JOIN tb_jenisujian ON ujian.id_jenis=tb_jenisujian.id_jenis WHERE id_ujian='$r[id_ujian]'  ");
												foreach ($jenis as $j)
												?>
  											<?= $j['jenis_ujian'] ?>
  										</td>
  													...
  													<div class="modal-content">
  														...
  														<div class="modal-body">
  															<div class="alert alert-info">
  																<?php
																	// tampilkan niali
																	$nilai = mysqli_query($con, "SELECT * FROM nilai WHERE id_siswa='$_SESSION[id_siswa]' ");
																	foreach ($nilai as $n)
																	?>
